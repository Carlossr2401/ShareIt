...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    // Admin Users
    "adminUsers.title": "Registered Users",
    "adminUsers.subtitle": "Search users to view their booking history and penalties.",
    ...
    "adminUsers.reservations": "Reservations",
    "adminUsers.penalties": "Penalties",
    "adminUsers.actions": "Actions",
    "adminUsers.viewDetail": "View Detail",
    "adminUsers.noUsers": "No users found",

    // Admin User Detail
    "adminUserDetail.back": "Back to Users",
    "adminUserDetail.title": "User Detail",
    "adminUserDetail.penaltyHistory": "Penalty History",
    "adminUserDetail.addPenalty": "Add Penalty",
    "adminUserDetail.date": "Date",
    "adminUserDetail.reason": "Reason",
    "adminUserDetail.points": "Points",
    "adminUserDetail.noPenalties": "No penalties registered",
    "adminUserDetail.bookingHistory": "Booking History",
    "adminUserDetail.resource": "Resource",
    "adminUserDetail.timeRange": "Time Range",
    "adminUserDetail.status": "Status",
    "adminUserDetail.noBookings": "No bookings registered",
    "adminUserDetail.addPenaltyTitle": "Add Penalty",
    "adminUserDetail.cancel": "Cancel",
    "adminUserDetail.add": "Add",
    "adminUserDetail.confirmDelete": "Are you sure you want to delete this penalty?",
    "adminUserDetail.deleteTitle": "Delete Penalty",
    "adminUserDetail.deleteMsg": "This action cannot be undone. Are you sure you want to remove this penalty from the user's record?",
    "adminUserDetail.deleteBtn": "Delete",
    "adminUserDetail.successAddTitle": "Penalty Added",
    "adminUserDetail.successAddMsg": "The penalty has been successfully added to the user's record.",
    "adminUserDetail.ok": "OK",
  ...
  es: {
    ...
    // Admin Users
    "adminUsers.title": "Usuarios Registrados",
    "adminUsers.subtitle": "Busca usuarios para ver su historial de reservas y penalizaciones.",
    "adminUsers.search": "Buscar por nombre o email...",
    "adminUsers.name": "Nombre",
    "adminUsers.email": "Email",
    "adminUsers.username": "Usuario",
    "adminUsers.role": "Rol",
    "adminUsers.reservations": "Reservas",
    "adminUsers.penalties": "Penalizaciones",
    "adminUsers.actions": "Acciones",
    "adminUsers.viewDetail": "Ver Detalle",
    "adminUsers.noUsers": "No se encontraron usuarios",

    // Admin User Detail
    "adminUserDetail.back": "Volver a Usuarios",
    "adminUserDetail.title": "Detalle de Usuario",
    "adminUserDetail.penaltyHistory": "Historial de Penalizaciones",
    "adminUserDetail.addPenalty": "Añadir Penalización",
    "adminUserDetail.date": "Fecha",
    "adminUserDetail.reason": "Motivo",
    "adminUserDetail.points": "Puntos",
    "adminUserDetail.noPenalties": "No hay penalizaciones registradas",
    "adminUserDetail.bookingHistory": "Historial de Reservas",
    "adminUserDetail.resource": "Recurso",
    "adminUserDetail.timeRange": "Horario",
    "adminUserDetail.status": "Estado",
    "adminUserDetail.noBookings": "No hay reservas registradas",
    "adminUserDetail.addPenaltyTitle": "Añadir Penalización",
    "adminUserDetail.cancel": "Cancelar",
    "adminUserDetail.add": "Añadir",
    "adminUserDetail.confirmDelete": "¿Seguro que quieres eliminar esta penalización?",
    "adminUserDetail.deleteTitle": "Eliminar Penalización",
    "adminUserDetail.deleteMsg": "Esta acción no se puede deshacer. ¿Estás seguro de que quieres eliminar esta penalización del historial del usuario?",
    "adminUserDetail.deleteBtn": "Eliminar",
    "adminUserDetail.successAddTitle": "Penalización Añadida",
    "adminUserDetail.successAddMsg": "La penalización se ha añadido correctamente al historial del usuario.",
    "adminUserDetail.ok": "Aceptar",
