...
const reservations = [
  { id: 1, user: "Carlos López", resource: "Conference Room A", date: "Mar 18, 2026", time: "10:00 – 12:00", status: "Confirmed", deposit: "€2.00" },
  { id: 2, user: "María García", resource: "Projector Epson #1", date: "Mar 19, 2026", time: "14:00 – 16:00", status: "Pending", deposit: "€1.00" },
  { id: 3, user: "Alex Johnson", resource: "Laptop Dell #7", date: "Mar 20, 2026", time: "09:00 – 13:00", status: "Confirmed", deposit: "€1.50" },
  { id: 4, user: "Sara Martínez", resource: "Van Mercedes", date: "Mar 15, 2026", time: "08:00 – 18:00", status: "Completed", deposit: "€5.00" },
  { id: 5, user: "David Chen", resource: "Classroom 101", date: "Mar 12, 2026", time: "11:00 – 13:00", status: "Cancelled", deposit: "€3.00" },
  { id: 6, user: "Laura Kim", resource: "Conference Room B", date: "Mar 21, 2026", time: "15:00 – 17:00", status: "Confirmed", deposit: "€2.00" },
  { id: 7, user: "James Wilson", resource: "Whiteboard Mobile #2", date: "Mar 22, 2026", time: "10:00 – 11:00", status: "Pending", deposit: "€0.50" },
];
        ...
        <CardContent sx={{ p: 0 }}>
          <TableContainer>
            <Table>
              <TableHead>
                <TableRow>
                  {[t("adminBook.user"), t("adminBook.resource"), t("adminBook.date"), t("adminBook.time"), t("adminBook.deposit"), t("adminBook.status")].map(h => (
